    ...
    handleSubmit = event => { 
        ...
        firebase
            ...
            .then(createdUser => {
                ...
                // After creating the user in firebase call the method updateProfile
                 createdUser.user.updateProfile({
                    displayName: this.state.username,
                    photoURL: `https://www.gravatar.com/avatar/${md5(createdUser.user.email)}?d=identicon` // generate photo
                })
                .then(() => {
                    // Saved the user in the realtime database
                ...
                .catch(err => {
                    console.log(err)
                    // push the error message to the array from the API
                    this.setState({
                        errors: this.state.errors.concat(err),
                        loading: false
                    })
                })
                // return to avoid error warning
                // return createdUser;
            })
